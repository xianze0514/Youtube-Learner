...
import { handleLearningMessage } from "./learning.js";
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  if (["ELT_OPEN_LEARNING", "ELT_GET_LEARNING", "ELT_LEARNING_TRANSCRIPT", "ELT_CACHE_LEARNING", "ELT_RETURN_SOURCE", "ELT_SAVE_PROGRESS", "ELT_LIST_HISTORY", "ELT_RESUME_LEARNING", "ELT_OPEN_CURRENT"].includes(message?.type)) {
